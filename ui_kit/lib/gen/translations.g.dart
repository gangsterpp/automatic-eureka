...
///
/// Locales: 3
/// Strings: 306 (102 per locale)
///
/// Built on 2025-05-06 at 14:52 UTC
...
import 'translations_am.g.dart' deferred as l_am;
import 'translations_kz.g.dart' deferred as l_kz;
...
enum AppLocale with BaseAppLocale<AppLocale, Translations> {
	...
	Future<Translations> build({
		...
		switch (this) {
			...
			case AppLocale.kz:
				await l_kz.loadLibrary();
				return l_kz.TranslationsKz(
					overrides: overrides,
					cardinalResolver: cardinalResolver,
					ordinalResolver: ordinalResolver,
				);
